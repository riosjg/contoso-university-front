...
export default function(){
    ...
    return ( 
        <>
            ...
            <button onClick={manageAddWindow} type="button">Add</button>
            <table>
                <thead>
                    <tr>
                        <th>Course ID</th>
            ...
            {showEdit && <Edit closeWindow={() => setShowEdit(!showEdit)} refresh={() => refreshList()} course={course} />}
